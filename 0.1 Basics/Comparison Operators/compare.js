...
console.log(firstFavNumb === secondFavNumb) //false  this means the type and value have to be the saame
console.log(firstFavNumb == secondFavNumb); //false  this means the number have the same

console.log(firstFavNumb !== secondFavNumb); //true  this means both the value and the type have to be different
console.log(5 != "5"); //true   the value is what matters, it doesn't check for type
